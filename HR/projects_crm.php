...
require 'conn.php';
    ...
    if(isset($_POST['savedata']))
    {
      ...
      $stmt = $pdo->prepare("INSERT into department(project, description, status, budget, duration, start, end, department) values (:project, :description, :status, :budget, :duration, :start, :end, 'Customer Relationship Management')");
...
<div class="text-start col-sm-6 col-md-8">CUSTOMER RELATIONSHIP MANAGEMENT PROJECTS</div>
...
<div class="modal fade" id="insertdata" tabindex="-1" aria-labelledby="insertdataLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="projects_crm.php" method="POST">
...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="editmodalLabel" aria-hidden="true">
  ...
  <?php 
  $stmt = $pdo->prepare("SELECT * from department where department = 'Customer Relationship Management' ");
  $stmt->execute();
